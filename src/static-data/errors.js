export const ErrorTypes = {
  ...
  STRIPE_ORDER_SOME_ALREADY_SOLD: 6,
};
...
export const Errors = {
  ...
  [ErrorTypes.STRIPE_ORDER_SOME_ALREADY_SOLD]: {
    type: 'StripeOrderSomeAlreadySold,',
    message: 'Some of the selected frames for checkout are already sold',
  },
};
